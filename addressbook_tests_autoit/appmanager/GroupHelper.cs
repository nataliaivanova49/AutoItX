...
using System.Linq;
using System.Text;
using System.Threading.Tasks;using AutoItX3Lib;
    ...
    public class GroupHelper : HelperBase
    {
        ...
        internal void Remove()
        {
            ...
            aux.ControlTreeView(GROUPWINTITLE, "",
                    "WindowsForms10.SysTreeView32.app.0.2c908d51", "Select", "#0|#0", "");
        ...
        {
            aux.ControlClick(WINTITLE, "", "WindowsForms10.BUTTON.app.0.2c908d512", "left");
            aux.WinWait(GROUPWINTITLE);
        }
    }
}
